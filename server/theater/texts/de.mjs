...
export const de = {
  ...
  'date.cast_title':    'Besetzung',
  'date.scene_title':   'Szenen',
  'date.scene_n':       'Szene {n}',
  'date.scene_none':    'Keine Szene zugeteilt.',
  'date.scene_add':     'Szene dazu …',
  'date.scene_remove':  'Szene weg …',
  'date.day':          'Tag',
  'hist.title':        'Gehaltene Proben',
  'hist.archive':       'Archiv',
  'hist.archive_n':     '{n} gehaltene Proben',
  ...
  'my.fix_which':       'Probe',
  'my.fix_go':          'fixieren',
  'my.fix_confirm':     '{id} am {tag} von {von} bis {bis} fixieren?',
  'my.fix_done':        'fixiert.',
  'my.fix_failed':      'Fehlgeschlagen.',
  ...
  'msg.needs_one_scene': 'Eine Probe braucht mindestens eine Szene.',
  'msg.scene_gone':     'Diese Szene gehört nicht (mehr) zu dieser Probe.',
  'msg.scene_already_there': 'Diese Szene gehört schon zu dieser Probe.',
  'msg.scene_moved':    'Szene {szene} von {from} zu {to} verschoben.',
  'msg.scene_dropped':  'Szene {szene} aus {id} genommen – offen, bis sie einer anderen Probe zugeteilt wird.',
  ...
  'r.add_scene':        'Welche Szene?',
  'r.remove_scene':     'Welche Szene?',
  ...
  'kd.adhoc_what':      'Wer ist da? Weiter und Zurück springen dann nur über diese Personen, und Abprüfen gilt für alle.',
  'kd.adhoc_start':     'Probe starten',
  'kd.adhoc_change':    'ändern',
  'kd.adhoc_end':       'beenden',
  'kd.adhoc_chosen':    '{n} gewählt',
