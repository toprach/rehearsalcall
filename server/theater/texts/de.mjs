...
export const de = {
  ...
  'date.release':       'lösen',
  'date.history':      'bisher:',
  'date.reads_for':    'Regie liest für:',
  'date.reads_n':      '{n} Einsätze in dieser Probe',
  ...
  'date.change_what':  'Tag, Uhrzeit und Ort. Danach steht die Nachricht zum Weiterleiten wieder da.',
  'date.change_go':    'Termin ändern',
  'date.day':          'Tag',
  'hist.title':        'Gehaltene Proben',
  'hist.what':         'Ein fester Termin, der vorbei ist, wandert hierher; die Probe ist dann wieder offen für den nächsten Termin. Tragen Sie im Nachgang ein, zu wie viel Prozent der Inhalt sitzt – was am schlechtesten sitzt, wird zuerst wieder vorgeschlagen.',
  'hist.sits':         'sitzt zu',
  'hist.note':         'Notiz',
  'hist.remove':       'entfernen',
  'hist.remove_confirm': 'Diesen Eintrag aus dem Verlauf entfernen – etwa weil die Probe ausgefallen ist?',
  'share.line_optional': 'Wenn es geht, auch dabei: {who} (kleine Einsätze, sonst liest die Regie)',
  'my.also_suits':     'Auch möglich: ',
  'r.date_changed':    'Termin von {p1} geändert.',
  'r.date_invalid':    'Bitte Tag und Uhrzeit prüfen – das Ende muss nach dem Anfang liegen.',
  'r.rated':           'Für {p1} eingetragen.',
  'r.history_removed': 'Eintrag von {p1} aus dem Verlauf entfernt.',
  'date.fix':   'festhalten',
  ...
  'kd.who_go':       'Weiter',
  'kd.adhoc':        'Ad-hoc-Probe',
  'kd.adhoc_what':   'Wer ist gerade da? Ankreuzen \u2013 dann sind die Szenen markiert, die sich mit diesen Leuten proben lassen; Probe und Szene in der Leiste springen nur noch dorthin. Bei den anderen steht, wer fehlt.',
  'kd.adhoc_go':     'Anwenden',
  'kd.adhoc_all':    'Alle Szenen',
  'kd.adhoc_count':  '{k} von {n} Szenen',
  'kd.adhoc_missing': 'fehlt: {who}',
  'kd.adhoc_none':   'Mit diesen Leuten l\u00e4sst sich keine Szene vollst\u00e4ndig proben.',
  'date.open_script': 'im Proben Skript \u00f6ffnen \u2013 erste Stelle dieser Probe',
  'date.extend':      'Personen dazu',
  'date.extend_long': 'Probe erweitern: Personen dazu, weitere Szenen',
  'ext.title':        'Probe {id} erweitern',
  'ext.back':         '\u2190 zur\u00fcck',
  'ext.what':         'Wer kommt noch dazu? F\u00fcr die gr\u00f6\u00dfere Besetzung sucht das Programm weitere Szenen \u2013 die stehen dann zur Wahl, und die Probe w\u00e4chst mit. So l\u00e4sst sich ein eigenes Probenprogramm zusammenstellen; der feste Termin bleibt. Neben jedem Namen steht, wer an dem Abend kann.',
  'ext.date':         'Termin: {when}',
  'ext.no_date':      'noch kein fester Termin, daher keine Verf\u00fcgbarkeiten',
  'ext.people':       'Wer kommt dazu?',
  'ext.nobody':       'Alle sind schon dabei.',
  'ext.reads_n':      'Regie liest bisher {n} Eins\u00e4tze',
  'ext.av_yes':       'kann, {from}\u2013{to}',
  'ext.av_part':      'nur teilweise, {from}\u2013{to}',
  'ext.av_no':        'kann nicht',
  'ext.av_unknown':   'keine Angabe',
  'ext.show':         'Szenen f\u00fcr diese Besetzung suchen',
  'ext.scenes_now':   'Bisher in dieser Probe',
  'ext.scenes_more':  'Dazu m\u00f6glich mit {who}',
  'ext.scenes_none':  'F\u00fcr diese Besetzung findet sich keine weitere Szene (Ersatzanteil wie im Plan).',
  'ext.scene_line':   '{act} \u00b7 Repliken {from}\u2013{to} \u00b7 {min} min \u00b7 Ersatz {share}',
  'ext.also_in':      'auch in {ids}',
  'ext.act_n':        'Akt {n}',
  'ext.save':         'Probe so speichern',
  'msg.needs_scene':  'Mindestens eine Szene muss bleiben.',
  'msg.extended':     'Probe {id}: {people} dazu, {added} Szenen mehr \u2013 jetzt {scenes} Szenen, {min} min.',
