...
export const en = {
  ...
  'date.week_of':       '{from} – {to}',
  'date.cast_title':    'Cast',
  'date.scene_title':   'Scenes',
  'date.scene_n':       'Scene {n}',
  'date.scene_none':    'No scene given to it.',
  'date.scene_add':     'Scene in …',
  'date.scene_remove':  'Scene out …',
  'date.day':          'Day',
  'hist.title':        'Rehearsals held',
  'hist.archive':       'Archive',
  'hist.archive_n':     '{n} rehearsals held',
  ...
  'my.fix_go':          'fix',
  'my.fix_confirm':     'Fix {id} on {tag} from {von} to {bis}?',
  'my.fix_done':        'Fixed.',
  'my.fix_failed':      'Failed.',
  ...
  'msg.needs_one_scene': 'A rehearsal needs at least one scene.',
  'msg.scene_gone':     'This scene does not belong to this rehearsal (any more).',
  'msg.scene_already_there': 'This scene already belongs to this rehearsal.',
  'msg.scene_moved':    'Scene {szene} moved from {from} to {to}.',
  'msg.scene_dropped':  'Scene {szene} taken out of {id} - open until it is given to another rehearsal.',
  ...
  'r.add_scene':        'Which scene?',
  'r.remove_scene':     'Which scene?',
  ...
  'kd.adhoc_what':      'Who is here? Forward and back then step through these people only, and checking covers them all.',
  'kd.adhoc_start':     'Start rehearsal',
  'kd.adhoc_change':    'change',
  'kd.adhoc_end':       'end',
  'kd.adhoc_chosen':    '{n} chosen',
