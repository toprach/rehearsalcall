...
export const en = {
  ...
  'proj.place':         'Rehearsal place',
  'proj.place_what':    'The usual place. It is prefilled when a date is fixed and confirmed or changed there.',
  'proj.place_label':   'Usual place',
  'r.place_saved':      'Rehearsal place saved.',
  'proj.road':          'The road',
  ...
  'date.history':      'so far:',
  'date.reads_for':    'The director reads for:',
  'date.reads_n':      '{n} cues in this rehearsal',
  ...
  'date.change_what':  'Day, time and place. Afterwards the message to pass on is there again.',
  'date.change_go':    'Change the date',
  'date.day':          'Day',
  'hist.title':        'Rehearsals held',
  'hist.what':         'A fixed date that is over moves here; the rehearsal is then open for its next date. Note afterwards how many per cent of it sit – what sits worst is proposed again first.',
  'hist.sits':         'sits at',
  'hist.note':         'note',
  'hist.remove':       'remove',
  'hist.remove_confirm': 'Remove this entry from the history – because the rehearsal did not take place, say?',
  'share.line_optional': 'If possible also: {who} (small parts, otherwise the director reads)',
  'my.also_suits':     'Also possible: ',
  'r.date_changed':    'Date of {p1} changed.',
  'r.date_invalid':    'Please check day and time – the end has to be after the start.',
  'r.rated':           'Noted for {p1}.',
  'r.history_removed': 'Entry of {p1} removed from the history.',
  'date.fix':   'fix',
  'date.confirm':  'Everyone has time \u2013 fix the date now',
  ...
  'fix.title':       'Fix rehearsal {id}',
  'fix.when':        '{weekday}, {date}, {from}\u2013{to}',
  'fix.with':        'With',
  'fix.place':       'Place',
  'fix.place_what':  'Prefilled with the usual place from the project settings \u2013 check it or change it.',
  'fix.place_none':  'The director has not set a usual place yet (project page).',
  'fix.go':          'Fix the date',
  'fix.cancel':      'cancel',
  'share.title':     'Message to the cast',
  'share.what':      'To pass on, say into the WhatsApp group. The link leads to the rehearsal; whoever is not signed in picks their name first.',
  'share.whatsapp':  'Via WhatsApp',
  'share.share':     'Share \u2026',
  'share.copy':      'Copy',
  'share.copied':    'copied',
  'share.line_head': 'Rehearsal {id} \u2013 {title}',
  'share.line_place': 'Place: {place}',
  'share.line_place_open': 'Place: still open',
  'share.line_with': 'With: {who}',
  'share.line_link': 'What is rehearsed: {link}',
  ...
  'my.autosave':      'Every entry is saved at once.',
  'my.saving':        'saving \u2026',
  'my.saved':         'saved {when}',
  ...
  'my.source_add':    'Add',
  'my.source_file':   'Load an .ics file',
  'my.source_remove': 'remove',
  'my.source_none':   'No calendar added yet.',
  'my.source_unreachable': 'cannot be fetched \u2013 check the address, or load the .ics file instead',
  'my.source_n':      '{n} entries in this period',
  'my.day_title':     'From my calendars:',
  'my.day_free':      'nothing on',
  'my.allday':        'all day',
  'my.bad_url':       'Please give an address starting with https://.',
  'my.bad_file':      'That file could not be read as a calendar.',
  'my.ics_title':     'Calendar subscription',
  'my.ics_what':      'Subscribe to this address in your own calendar (Google: \u201cFrom URL\u201d, iPhone: calendar '
                    + 'subscription): every rehearsal with a date, proposals as tentative, and your own evenings. '
                    + 'The link stands for you personally.',
  /* the feed itself */
  'ics.with_me':      'Rehearsal {id}: me + {others}',
  'ics.with_me_alone': 'Rehearsal {id}: me',
  'ics.without_me':   'Rehearsal {id} without me \u2013 rehearsing: {who}',
  'ics.proposal':     'Proposal: ',
  'ics.proposal_what': 'Tentative \u2013 the proposal is recomputed with every entry.',
  'ics.cast':         'Cast: {who}',
  'ics.place':        'Place: {place}',
  'ics.passages':     'Passages: {url}',
  'ics.free':         'Available for a rehearsal',
  'ics.free_what':    'Entered in the rehearsal planner \u201c{title}\u201d.',
  'my.nobody':      'nobody',
  'my.can_n':    '{n} can',
  ...
  'r.now_fixed': '{p1} is now firmly arranged. You can pass the message below on to the others.',
  ...
  'book.adhoc_what':  'Who is around right now? Tick them, and you learn exactly the cues you get from these people.',
  'book.adhoc_go':    'Learn these cues',
  'mdate.adhoc':      'Ad-hoc rehearsal',
  'book.filter_all': 'all passages',
  'book.filter_back': 'back to the rehearsal',
  'text.learn_this': 'Learn this rehearsal',
  'text.learn_this_what': 'the learning mode, only with the passages that come up here',
  ...
  'book.mode_review': 'Review',
  'book.review_what': 'What is already learnt, in the order of the play \u2013 even if it is not due today. '
                   + 'The answers count as in learning.',
  'book.nothing_learnt': 'Nothing learnt yet',
  'book.nothing_learnt_what': 'What has been answered under \u201cLearn\u201d shows up here.',
  'book.back':       'Back',
  'book.back_what':  'The passage before, open once more.',
  'book.applause_title': 'Applause \u2013 ten minutes of practice!',
  'book.continue':   'Keep going',
  'book.tomorrow':   'Rather tomorrow',
  'book.applause_text': '{n} passages in this round. Better a little every day: keep going now or carry on tomorrow?',
  ...
  'kd.who_go':       'Continue',
  'kd.adhoc':        'Ad hoc rehearsal',
  'kd.adhoc_what':   'Who is here right now? Tick them, and the scenes that can be rehearsed with these people are marked; rehearsal and scene in the bar then jump only there. The others say who is missing.',
  'kd.adhoc_go':     'Apply',
  'kd.adhoc_all':    'All scenes',
  'kd.adhoc_count':  '{k} of {n} scenes',
  'kd.adhoc_missing': 'missing: {who}',
  'kd.adhoc_none':   'No scene can be rehearsed in full with these people.',
  'date.open_script': 'open in the rehearsal script, at the first passage of this rehearsal',
  'date.extend':      'Add people',
  'date.extend_long': 'Extend the rehearsal: more people, more scenes',
  'ext.title':        'Extend rehearsal {id}',
  'ext.back':         '\u2190 back',
  'ext.what':         'Who else is coming? For the larger cast the program looks for further scenes - they are offered for the choosing, and the rehearsal grows with them. That is how a rehearsal programme of your own comes about; the fixed date stays. Beside every name stands who can make that evening.',
  'ext.date':         'Date: {when}',
  'ext.no_date':      'no fixed date yet, so no availability',
  'ext.people':       'Who is coming as well?',
  'ext.nobody':       'Everybody is in already.',
  'ext.reads_n':      'the director reads {n} speeches so far',
  'ext.av_yes':       'can, {from}\u2013{to}',
  'ext.av_part':      'only partly, {from}\u2013{to}',
  'ext.av_no':        'cannot',
  'ext.av_unknown':   'nothing entered',
  'ext.show':         'Find scenes for this cast',
  'ext.scenes_now':   'In this rehearsal so far',
  'ext.scenes_more':  'Possible as well with {who}',
  'ext.scenes_none':  'No further scene comes up for this cast (substitution share as in the plan).',
  'ext.scene_line':   '{act} \u00b7 cues {from}\u2013{to} \u00b7 {min} min \u00b7 substitution {share}',
  'ext.also_in':      'also in {ids}',
  'ext.act_n':        'Act {n}',
  'ext.save':         'Save the rehearsal like this',
  'msg.needs_scene':  'At least one scene has to stay.',
  'msg.extended':     'Rehearsal {id}: {people} joined, {added} more scenes - now {scenes} scenes, {min} min.',
