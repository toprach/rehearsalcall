...
for (const { code } of LANGUAGES) {
  ...
  const pages = {
    ...
    planPage: () => A.planPage(project, { kind: 'good', key: 'r.derived', values: { p1: 2, p2: { share: 0.93 } } },
      [{ nr: 1, name: 'ACT I' }, { nr: 2, name: 'ACT II' }]),
    ...
    datesShare: () => A.datesPage(project, datesResult, { kind: 'good', key: 'r.fixed', values: { p1: 'P01' } },
      { text: A.rehearsalMessage(project, { probe_id: 'P01', iso: '2026-10-01', von: '19:00', bis: '20:00', gruppe: ['OBERON', 'PUCK'], ort: 'Barn <east>' },
    ...
    bookPage: () => A.bookPage(project, person, [
      { i: 1, nr: 3, act: 'ACT I', chapter: 'SCENE I', cue: { who: 'PUCK', text: 'How now, spirit!', nr: 2 },
        ...
        ctxBefore: [{ who: 'PUCK', text: 'a <b', cont: false }, { text: 'Enter.', dir: true }], ctxAfter: [{ who: 'X', text: 'y' }],
        chunks: [{ key: 'k1.a', cue: { who: 'PUCK', text: 'How now, spirit!' }, lines: [{ who: 'OBERON', text: 'Ill met' }],
                   before: [], after: [], teil: [1, 2], words: 2 },
                 { key: 'k2.b', cue: { who: 'OBERON', text: 'Ill met', own: true }, lines: [{ who: 'OBERON', text: 'Tarry.' }],
    ...
    bookFiltered: () => A.bookPage(project, person, [], 0, {}, '2026-09-14', [], null, { id: 'P<1>', ranges: [[1, 9]] }),
    bookAdhoc: () => A.bookPage(project, person, [], 0, {}, '2026-09-14', [], null, { mit: [project.personen[1].b] }),
